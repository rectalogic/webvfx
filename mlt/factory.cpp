...
{
    MLT_REGISTER(mlt_service_producer_type, "vfxpipe", createService);
    MLT_REGISTER(mlt_service_filter_type, "vfxpipe", createService);
    MLT_REGISTER(mlt_service_transition_type, "vfxpipe", createService);
}
